...
void AddObjects::addShelf(){
	...
	shapes::Mesh* m = shapes::createMeshFromResource("package://amazon/collision_objects/pod_lowres.stl");
...
void AddObjects::addScoop(std::string side){
	...
	if(side == "right"){
        ...
        shapes::Mesh* m = shapes::createMeshFromResource("package://amazon/collision_objects/scoop.stl");
